...
namespace SimpleWeb {
    ...
    public:
            ...
            void async_flush(std::function<void(const boost::system::error_code&)> callback=nullptr) {
                ...
                *async_writing=true;
                ...
                boost::asio::async_write(*socket, *write_buffer, 
                        ...
                        (const boost::system::error_code& ec, size_t ) { // size_t bytes_transferred
        ...
        std::unordered_map<std::string, std::unordered_map<std::string, 
            std::function<void(typename ServerBase<socket_type>::Response&,
    ...
    protected:
        ...
        std::shared_ptr<boost::asio::deadline_timer> set_timeout_on_socket(std::shared_ptr<socket_type> socket, size_t seconds) {
            ...
            timer->expires_from_now(boost::posix_time::seconds(long(seconds)));
